(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&l(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(e){if(e.ep)return;e.ep=!0;const a=s(e);fetch(e.href,a)}})();function i({layout:t="full",currentPage:o="home"}={}){const s=`
    ...
    `}function c({currentPage:t="home"}={}){return`
    <!-- Header Navigation -->
    ...
    `}function n(){const t=document.getElementById("footer-placeholder");if(t){const s=window.location.pathname.includes("pve.html"),l=s?"full":"simple",e=s?"pve":"home";t.innerHTML=i({layout:l,currentPage:e})}const o=document.getElementById("header-placeholder");if(o){const l=window.location.pathname.includes("pve.html")?"pve":"home";o.innerHTML=c({currentPage:l})}d()}function d(){const t=document.getElementById("mobile-menu-button"),o=document.getElementById("mobile-menu");t&&o&&(t.addEventListener("click",()=>{o.classList.toggle("hidden")}),document.addEventListener("click",s=>{!t.contains(s.target)&&!o.contains(s.target)&&o.classList.add("hidden")}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n();
