function n({layout:t="full",currentPage:e="home"}={}){const o=`
        <footer class="bg-slate-800 dark:bg-slate-950 text-slate-300 ${t==="full"?"mt-16":"py-12"}">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${t==="simple"?"text-center":"py-12"}">
    `;return t==="simple"?o+`
                <div class="mb-4">
    ...
    `:o+`
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="index.html" class="${e==="home"?"text-blue-400 hover:text-blue-300":"text-slate-400 hover:text-white"} transition-colors duration-200">Home</a></li>
                            <li><a href="pve.html" class="${e==="pve"?"text-blue-400 hover:text-blue-300":"text-slate-400 hover:text-white"} transition-colors duration-200">PvE Content</a></li>
                            <li><a href="noobtacoui.html" class="${e==="noobtacoui"?"text-blue-400 hover:text-blue-300":"text-slate-400 hover:text-white"} transition-colors duration-200">NoobTacoUI</a></li>
    ...
    `}function i({currentPage:t="home"}={}){return`
    <!-- Header Navigation -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="index.html" class="${t==="home"?"text-blue-600 dark:text-blue-400 font-semibold":"text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-100 font-medium transition-colors duration-200"}">
                        Home
                    </a>
                    <a href="pve.html" class="${t==="pve"?"text-blue-600 dark:text-blue-400 font-semibold":"text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-100 font-medium transition-colors duration-200"}">
                        PvE Content
                    </a>
                    <a href="noobtacoui.html" class="${t==="noobtacoui"?"text-blue-600 dark:text-blue-400 font-semibold":"text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-100 font-medium transition-colors duration-200"}">
                        NoobTacoUI
                    </a>
    ...
    `}function r(){const t=document.getElementById("footer-placeholder");if(t){const o=window.location.pathname.includes("pve.html"),a=window.location.pathname.includes("noobtacoui.html"),s=o||a?"full":"simple",l=o?"pve":a?"noobtacoui":"home";t.innerHTML=n({layout:s,currentPage:l})}const e=document.getElementById("header-placeholder");if(e){const o=window.location.pathname.includes("pve.html"),a=window.location.pathname.includes("noobtacoui.html"),s=o?"pve":a?"noobtacoui":"home";e.innerHTML=i({currentPage:s})}c()}function c(){const t=document.getElementById("mobile-menu-button"),e=document.getElementById("mobile-menu");t&&e&&(t.addEventListener("click",()=>{e.classList.toggle("hidden")}),document.addEventListener("click",o=>{!t.contains(o.target)&&!e.contains(o.target)&&e.classList.add("hidden")}))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",r):r();
